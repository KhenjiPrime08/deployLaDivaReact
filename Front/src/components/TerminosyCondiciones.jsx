...
const ModalTerminos = ({ show, onClose }) => {
  ...
  return (
    <div className={`modal-terminos ${darkMode ? 'modal-terminos-dark' : ''}`}>
      <div className="modal-terminos__backdrop" onClick={onClose} />
      <div className="modal-terminos__content">
        
        <h2 className="modal-terminos__title">Términos y Condiciones</h2>
        <div className="modal-terminos__body">
          <p>De acuerdo con el decreto Boletín Oficial de Canarias num.225, es nuestra responsabilidad
            ...
            Toda la información que se pide es de carácter CONFIDENCIAL y es
            necesaria para adecuar nuestro trabajo a tus necesidades específicas.
          </p>

          <ul className="modal-terminos__list">
            <li>Se comprobará la ausencia local de lesiones u otras contraindicaciones.</li>
            <li>Empleo de material de un solo uso y/o estéril. Las agujas son de un solo uso, pre esterilizadas y desechables.
              Los pigmentos utilizados cuentan con homologación y cumplen con la actual normativa.
            </li>
            <li>Se desprecintará el material en presencia del cliente.</li>
            <li>Limpieza y desinfección del área de trabajo y zona anatómica sobre la que se usará el material.</li>
            <li>Desechado el material sobrante en presencia del cliente.</li>
          </ul>
          ...
          <p>
            ...
            irritación, inflamación, incrustación de la joya alergia o rechazo a la tinta y otras dolencias causadas por motivos muy diversos,
            entre los cuales se incluyen una curación inadecuada, sensibilidad específica en cada piel, alergias, estado del sistema inmunológico
            de cada persona y otras causas.
          </p>

          <p>
            Soy consciente que el tatuaje puede condicionarme en futuras prácticas médicas 
            (inyección epidural en caso de tatuajes en la zona lumbar, injertos de piel, donación). 
            Del mismo modo soy consciente de que un tatuaje es para toda la vida.
          </p>

          <p>
            Entiendo y acepto que en la realización del tatuaje o piercing puedo desarrollar una alergia a alguno de los materiales utilizados.
            Acepto contactar con <b> LA DIVA TATTOO </b>, para resolver cualquier duda o inconveniencia durante la curación.
            Así mismo consultar a mi médico en caso de que sea necesario.
          </p>

          <p>
            Cualquier problema de mi tatuaje/piercing que no esté demostrablemente causado por una praxis 
            ...
            riesgo de lesión o daño corporal durante la práctica, así como los costes en caso de hacer un trabajo de retoque por mi negligencia 
            en la curación del tatuaje / piercing. Convengo en pagar cualquier coste por daños y perjuicios en caso de haberlos a la empresa o a
            cualquier o todas las personas pertenecientes en <b>LA DIVA TATTOO</b>
          </p>

          <h2 className="modal-terminos__title">CONSENTIMIENTO:</h2>

          <p>
            Habiendo leído esto, acepto que he sido debidamente informado oralmente y por escrito, así como haber recibido las 
            instrucciones necesarias (orales y escritas) para el adecuado cuidado de mi piercing / tatuaje y que soy plenamente 
          ...
          <p>
            ...
            Doy el consentimiento a los artistas de <b>LA DIVA TATTOO</b> para publicar los trabajos en redes sociales y otros medios. 
          </p>

          <p>No se devuelve el dinero una vez hecho el tatuaje.</p>
          ...
          <p>1.- Infección local. / 1 Local infection <br />
          ...
          <p>2.- Infección general. / 2 general infection <br/>
          ...
          <p>5.- Cicatrices patológicas. / 5 scarring <br/>
